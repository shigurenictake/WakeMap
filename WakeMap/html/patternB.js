...
function InitWake() {
    ...
    {\
        aWake1:{\
            ...
            pos3:{ x: 121.259 , y: 31.974 , 'date': '20230101' , 'time': '001133' },\
            pos4:{ x: 123.925 , y: 30.197 , 'date': '20230101' , 'time': '001144' }\
        },\
        aWake2:{\
            info:{ row: 2, id: 2 },\
            pos1:{ x: 136.700 , y: 39.000 , 'date': '20230101' , 'time': '001100' },\
            pos2:{ x: 136.200 , y: 39.000 , 'date': '20230101' , 'time': '001110' },\
            pos3:{ x: 135.500 , y: 38.600 , 'date': '20230101' , 'time': '001120' },\
            pos4:{ x: 134.800 , y: 38.500 , 'date': '20230101' , 'time': '001130' },\
            pos5:{ x: 134.200 , y: 38.800 , 'date': '20230101' , 'time': '001140' },\
            pos6:{ x: 133.800 , y: 38.800 , 'date': '20230101' , 'time': '001150' },\
            pos7:{ x: 133.572 , y: 39.781 , 'date': '20230101' , 'time': '001200' },\
            pos8:{ x: 136.238 , y: 40.479 , 'date': '20230101' , 'time': '001300' },\
            pos9:{ x: 134.080 , y: 41.495 , 'date': '20230101' , 'time': '001400' }\
        },\
        aWake3:{\
            info:{ row: 3, id: 3 },\
            pos1:{ x: 143.855 , y: 34.703 , 'date': '20230102' , 'time': '001111' },\
            pos2:{ x: 145.505 , y: 33.307 , 'date': '20230102' , 'time': '001122' },\
    ...
    {\
        dTrack1:{\
            info:{ row: 1, id: 1 },\
            pos1:{ x: 138.995 , y: 39.962 , 'date': '20230101' , 'time': '001100' },\
            pos2:{ x: 136.985 , y: 39.762 , 'date': '20230101' , 'time': '001110' },\
            pos3:{ x: 134.110 , y: 38.458 , 'date': '20230102' , 'time': '001150' },\
            pos4:{ x: 132.127 , y: 36.647 , 'date': '20230102' , 'time': '001200' }\
        },\
        dTrack2:{\
            info:{ row: 2, id: 2 },\
            pos1:{ x: 139.062 , y: 41.319 , 'date': '20230101' , 'time': '001100' },\
            pos2:{ x: 136.253 , y: 41.067 , 'date': '20230101' , 'time': '001110' },\
            pos3:{ x: 131.954 , y: 40.894 , 'date': '20230102' , 'time': '001150' },\
            pos4:{ x: 129.930 , y: 41.506 , 'date': '20230102' , 'time': '001200' }\
        }\
    }\
    ";
    ...
    {\
        bWake1:{\
            info:{ row: 1, id: 1 },\
            pos1:{ x: 135.735 , y: 36.043 , 'date': '20230101' , 'time': '001110' },\
            pos2:{ x: 135.552 , y: 39.055 , 'date': '20230101' , 'time': '001120' },\
            pos3:{ x: 135.220 , y: 38.740 , 'date': '20230101' , 'time': '001130' },\
            pos4:{ x: 134.321 , y: 38.955 , 'date': '20230101' , 'time': '001140' },\
            pos5:{ x: 135.486 , y: 36.593 , 'date': '20230101' , 'time': '001150' }\
        },\
        bWake2:{\
            info:{ row: 2, id: 2 },\
            pos1:{ x: 139.310 , y: 40.000 , 'date': '20230101' , 'time': '001111' },\
            pos2:{ x: 135.183 , y: 39.773 , 'date': '20230101' , 'time': '001122' },\
            pos3:{ x: 135.533 , y: 40.572 , 'date': '20230101' , 'time': '001133' },\
            pos4:{ x: 135.233 , y: 41.088 , 'date': '20230101' , 'time': '001144' },\
            pos5:{ x: 139.393 , y: 40.588 , 'date': '20230101' , 'time': '001155' }\
        },\
        bWake3:{\
            info:{ row: 3, id: 3 },\
            pos1:{ x: 139.426 , y: 39.623 , 'date': '20230102' , 'time': '001111' },\
            pos2:{ x: 132.405 , y: 39.041 , 'date': '20230102' , 'time': '001122' },\
    ...
    {\
        cPlace1:{\
            info:{ row: 1, id: 1 },\
            pos1:{ x: 135.615 , y: 38.200 , 'date': '20230101' , 'time': '001110' },\
            pos2:{ x: 135.432 , y: 38.800 , 'date': '20230101' , 'time': '001120' },\
            pos3:{ x: 134.767 , y: 38.300 , 'date': '20230101' , 'time': '001130' },\
            pos4:{ x: 134.534 , y: 39.100 , 'date': '20230101' , 'time': '001140' },\
            pos5:{ x: 134.000 , y: 38.400 , 'date': '20230101' , 'time': '001150' }\
        },\
        cPlace2:{\
            info:{ row: 2, id: 2 },\
    ...
    {\
        arrow1:{\
            ...
            pos:{ x: 135.615 , y: 38.200 , direction: 120 , distance: 0.4 , 'date': '20230101' , 'time': '001110' }\
        },\
        arrow2:{\
            primaryKey:{ row: 2, id: 2 },\
            pos:{ x: 135.432 , y: 38.800 , direction: 225 , distance: 0.3 , 'date': '20230101' , 'time': '001120' }\
        },\
        arrow3:{\
            primaryKey:{ row: 3, id: 3 },\
            pos:{ x: 134.767 , y: 38.300 , direction:  80 , distance: 0.3 , 'date': '20230101' , 'time': '001130' }\
        },\
        arrow4:{\
            primaryKey:{ row: 4, id: 4 },\
            pos:{ x: 134.534 , y: 39.100 , direction: 290 , distance: 0.2 , 'date': '20230101' , 'time': '001140' }\
        },\
        arrow5:{\
            primaryKey:{ row: 5, id: 5 },\
            pos:{ x: 134.000 , y: 38.400 , direction: 290 , distance: 0.2 , 'date': '20230101' , 'time': '001150' }\
        }\
    }\
    ";
